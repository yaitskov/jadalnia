...
class CashiersControl extends TransCom<{fid: Fid}, CashiersControlS> {
  // @ts-ignore
  ...
  wMnt() {
    this.$volunteerSr.listByType(this.props.fid, Kasier)
...
export default function loadBundle(bundleName: string, mainContainer: Container)
  : Instantiable<CashiersControl> {
  return regBundleCtx(bundleName, mainContainer, CashiersControl,
